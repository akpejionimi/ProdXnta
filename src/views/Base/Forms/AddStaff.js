                    ...
                    <Row>
                      ...
                      <Col md={{ size: 6 }}>
                        <FormGroup>
                          ...
                          <Input type="select" name="department" id="department" required="required"
                            onChange={this.onChanged}>
                  ...
                  <FormGroup>
                    <Row>
                      ...
                      <FormGroup>
                          ...
                          <Input type="select" name="gender" id="gender" required="required" 
                            onChange={this.onChanged}>
                      ...
                      <FormGroup>
                          ...
                          <Input type="select" name="status" id="status" required="required"
                            onChange={this.onChanged}>
