...
function StaffRow(props) {
  ...
  return (
    <tr key={staff.staffId.toString()}>
      ...
      <td><Link to={StaffEditLink}><Button color="primary"><i className= "fa fa-edit"></i></Button></Link>
        <Button onClick={() => props.removeStaff(staff)} color="danger"><i className= "fa fa-trash"></i></Button>
      </td>
    </tr>
  )
}
